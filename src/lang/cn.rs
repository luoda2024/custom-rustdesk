...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "Dicad.cn"),
        ("About", "关于"),
        ("Slogan_tip", "LUODA创新AI赋能提速1000%高效出图交付!"),
        ("Privacy Statement", "免费解压游戏"),
        ("Mute", "静音"),
        ("Build Date", "构建日期"),
        ("Version", "版本"),
        ("Home", "主页"),
        ...
        ("Connection Error", "连接错误（是否已登陆API？）"),
        ("Error", "错误"),
        ("Reset by the peer", "连接被对方关闭"),
        ("Connecting...", "正在连接Dicad.cn服务器..."),
        ("Connection in progress. Please wait.", "正在连接Dicad.cn服务器，请稍候。"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "欢迎浏览器输入以下“Dicad.cn”网址，免费畅玩平台全部解压游戏！友情提醒：你正在受限运行软件未安装版，请点击下面的“安装”按钮将软件安装到系统，即可使用全部功能版本。"),
        ...
        ("Maximize", "最大化"),
        ("Your Device", "你的设备"),
        ("empty_recent_tip", "欢迎登陆！免费又好玩的游戏平台：Dicad.cn ！"),
